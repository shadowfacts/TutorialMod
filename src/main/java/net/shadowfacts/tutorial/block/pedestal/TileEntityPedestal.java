	...
	public ItemStackHandler inventory = new ItemStackHandler(1) {
		...
		protected void onContentsChanged(int slot) {
			if (!worldObj.isRemote) {
				...
				TutorialMod.network.sendToAllAround(new PacketUpdatePedestal(TileEntityPedestal.this), new NetworkRegistry.TargetPoint(worldObj.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), 64));
			}
		}
	};
